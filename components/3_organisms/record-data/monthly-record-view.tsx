...
export const MonthlyRecordView: React.FC<MonthlyRecordViewProps> = ({ monthlyData, onExport }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-900">月次統計レポート</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">主要カテゴリ</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{summary.topCategory}</div>
            <div className="text-sm text-gray-500 mt-1">最も多い記録種別</div>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">トレンド</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2">
              <TrendingUp
                className={`w-6 h-6 ${
                  ...
                  weeklyAverages[weeklyAverages.length - 1] > weeklyAverages[0]
                    ? 'text-green-600'
                    : 'text-gray-400'
                }`}
              />
            ...
            <div className="text-sm text-gray-500 mt-1">記録数の推移</div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="text-sm text-blue-600 mt-1">
                全体の
                {(
                  (stats.reduce((sum, stat) => sum + stat.careRecordCount, 0) /
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              ...
              <div className="text-sm text-green-600 mt-1">
                全体の
                {(
                  (stats.reduce((sum, stat) => sum + stat.nursingRecordCount, 0) /
                    summary.totalRecords) *
                  100
                ).toFixed(1)}
                %
            ...
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
              ...
              <div className="text-sm text-orange-600 mt-1">
                全体の
                {(
                  (stats.reduce((sum, stat) => sum + stat.handoverCount, 0) /
                    summary.totalRecords) *
                  100
                ).toFixed(1)}
                %
