...
export const CareRecordList: React.FC<CareRecordListProps> = ({ records, className = '' }) => {
      ...
      <Card>
        <CardHeader className="pb-4">
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            <CareRecordSearchBar onSearch={setSearchQuery} className="flex-1 max-w-md" />
