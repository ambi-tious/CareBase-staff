...
import { FileFolderIcon } from '@/components/1_atoms/resident-files/file-folder-icon';
...
import { ResidentFilesQuickViewModal } from '@/components/3_organisms/modals/resident-files-quick-view-modal';
...
export const ResidentCard: React.FC<ResidentCardProps> = ({ resident, className = '' }) => {
  ...
  // Get resident files
  const residentFiles = getResidentFilesByResidentId(String(resident.id));

  const handleFilesModalOpen = () => {
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <FileFolderIcon
                      onClick={handleFilesModalOpen}
                      fileCount={residentFiles.length}
                    />
                  </div>
                </div>
