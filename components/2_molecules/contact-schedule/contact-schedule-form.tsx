...
export const ContactScheduleForm: React.FC<ContactScheduleFormProps> = ({
  ...
  const [categories, setCategories] = useState<
    Array<{ id: string; name: string; isSystem: boolean; isUsed: boolean }>
  >([]);
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="重要度を選択してください" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select
                      ...
                      defaultValue={!field.value || field.value === '' ? 'none' : field.value}
                      disabled={isSubmitting || isSavingDraft}
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="関連利用者を選択してください" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
