...
| 登録処理   | 新しい服薬状況記録を登録       | `/v1/residents/{id}/medication-status`            | 同一画面（モーダル閉じる） |
| 編集処理   | 既存の服薬状況記録を更新       | `/v1/residents/{id}/medication-status/{statusId}` | 同一画面（モーダル閉じる） |
| 削除処理   | 既存の服薬状況記録を削除       | `/v1/residents/{id}/medication-status/{statusId}` | 同一画面（モーダル閉じる） |
...
| メソッド | エンドポイント                                    | 説明                     |
| -------- | ------------------------------------------------- | ------------------------ |
| POST     | `/v1/residents/{id}/medication-status`            | 新しい服薬状況記録を作成 |
| PUT      | `/v1/residents/{id}/medication-status/{statusId}` | 既存の服薬状況記録を更新 |
| DELETE   | `/v1/residents/{id}/medication-status/{statusId}` | 服薬状況記録を削除       |
