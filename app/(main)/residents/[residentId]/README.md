...
| -------------------- | -------------- | ---- | -------------- | ---------------- | ---------------- |
| 戻るボタン           | Link           | -    | 常時           | 利用者一覧に戻る | 青色アウトライン |
| 編集ボタン           | Button         | -    | 常時           | 編集             | 青色アウトライン |
...
| ---------------------- | ---------------------------- | ----------------------------------------- | ------------------------ |
| 戻るボタン             | 利用者一覧画面に遷移         | -                                         | 利用者一覧画面           |
| 編集ボタン             | 利用者編集画面に遷移         | -                                         | 利用者編集画面           |
...
| ------------ | ------------ | -------------- | -------------------------- |
| 利用者ID     | ページロード | 存在チェック   | ご利用者が見つかりません   |
...
- **戻るボタン**: `bg-white border-gray-300 text-gray-700 hover:bg-gray-50`
