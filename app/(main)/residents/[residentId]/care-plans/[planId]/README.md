...
| 初期データ取得 | ケアプラン詳細情報取得   | `/v1/care-plans/[planId]`    | -                           |
| 利用者情報取得 | 利用者基本情報取得       | `/v1/residents/[residentId]` | -                           |
...
| メソッド | エンドポイント               | 説明                   |
| -------- | ---------------------------- | ---------------------- |
| GET      | `/v1/care-plans/[planId]`    | ケアプラン詳細情報取得 |
| GET      | `/v1/residents/[residentId]` | 利用者基本情報取得     |
