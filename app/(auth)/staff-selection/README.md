...
<img width="855" height="814" alt="image" src="https://github.com/user-attachments/assets/2cfef346-0ebd-4ff7-a3bd-d7dc5668798f" />
...
| グループ選択エリア   | GroupSelector  | ◯    | 複数グループ存在時 | -                          | 2列（モバイル）→4列（デスクトップ）グリッド |
| チーム選択エリア     | TeamSelector   | ◯    | 複数チーム存在時   | -                          | 2列（モバイル）→4列（デスクトップ）グリッド |
| スタッフ選択エリア   | StaffSelector  | ◯    | チーム選択後       | -                          | 2列（モバイル）→4列（デスクトップ）グリッド |
...
- **グループ選択**: 2列（モバイル）→ 4列（デスクトップ）
- **チーム選択**: 2列（モバイル）→ 4列（デスクトップ）
- **スタッフ選択**: 2列（モバイル）→ 4列（デスクトップ）
