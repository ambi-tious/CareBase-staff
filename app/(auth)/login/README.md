...
| -------------- | ------------------------------ | ---------------------- | --------------------------------- |
| ログインボタン | 施設IDとパスワードで認証を実行 | `/v1/auth/staff/login` | 職員選択画面 (`/staff-selection`) |
...
| エンドポイント                     | 説明                   |
| ---------------------------------- | ---------------------- |
| `/v1/auth/staff/login`             | 職員ログイン           |
| `/v1/auth/staff/select`            | 職員選択               |
| `/v1/auth/staff/password-reminder` | パスワードリマインダー |
| `/v1/auth/staff/password-reset`    | パスワードリセット     |
