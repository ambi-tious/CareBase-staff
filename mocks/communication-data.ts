...
export const communicationRecordsData: CommunicationRecord[] = [
  {
    ...
    communicationContent: 'お父様の血圧が少し高めになっているとのご連絡をいただきました。最近の食事や水分摂取について心配されています。',
    responseContent: '血圧については主治医と相談し、塩分制限を強化しています。水分摂取量も記録を取り、適切な量を維持しています。次回受診時に詳しく相談予定です。',
    isImportant: true,
    threadId: 'thread-001',
  ...
  },
  {
    ...
    contactPersonName: '佐藤健太',
    contactPersonType: 'family',
    communicationContent: '昨日の血圧の件で追加のご質問をいただきました。薬の調整について主治医からの説明を求められています。',
    responseContent: '主治医の田中先生から、現在の薬で様子を見ることになったとお伝えしました。1週間後に再度血圧測定を行い、必要に応じて薬の調整を検討する予定です。',
    isImportant: false,
    threadId: 'thread-001',
    parentId: 'comm-001',
  ...
  },
  {
    ...
    contactPersonType: 'family',
    communicationContent: 'お母様の認知症の症状について、最近物忘れが増えているのではないかとご心配のお電話をいただきました。',
    responseContent: '確かに最近、日付や時間の認識に混乱が見られることがあります。しかし、ご家族のお顔は覚えていらっしゃいます。認知症専門医との相談を提案し、ご家族も同意されました。',
    isImportant: true,
    threadId: 'thread-002',
  ...
  },
  {
    ...
    communicationContent: '近所の方から、鈴木様が最近散歩中に転倒しそうになったとのご連絡をいただきました。歩行状態について確認を求められています。',
    responseContent: '歩行器の使用を徹底し、外出時は必ず職員が付き添うようにしています。理学療法士とも相談し、バランス訓練を強化する予定です。ご近所の方にもお礼をお伝えしました。',
    isImportant: true,
    threadId: 'thread-003',
  ...
  },
  {
    ...
    contactPersonType: 'family',
    communicationContent: 'お義父様の最近の様子について、食事の摂取量が気になるとのお電話をいただきました。',
    responseContent: '食事摂取量は記録を取っており、平均して7-8割程度です。好みの食事を提供し、食事時間も調整しています。栄養士とも相談し、栄養バランスは問題ありません。',
    isImportant: false,
    threadId: 'thread-004',
