...
export const useFolderManagement = ({ initialFolders, categoryKey }: UseFolderManagementOptions) => {
  ...
  // フォルダ更新
  const updateFolder = useCallback(async (folderId: string, folderName: string): Promise<boolean> => {
    try {
